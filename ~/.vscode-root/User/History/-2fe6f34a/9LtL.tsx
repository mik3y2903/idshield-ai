...
export const AnalysisResultPage: React.FC<{ 
  ...
  const [activeTab, setActiveTab] = useState<'evidence' | 'comparison' | 'signals'>('evidence');
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Core Metrics: Risk Gauge & Integrity Gauges */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        {/* Multi-Factor Verification Meters */}
      ...
      {/* Side-By-Side Interactive Visual Evidence */}
      <EvidenceViewer regions={doc.evidenceRegions} />

      {/* Explainable AI Reasoning & Additive Waterfall Risk Matrix */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left: Natural Language AI Explanation */}
        ...
        {/* Right: Risk Factor Tree Breakdown */}
        <div className="lg:col-span-6">
          <RiskWaterfall factors={doc.riskBreakdown} totalScore={doc.riskScore} />
        </div>
      </div>

      {/* Secondary Forensic Modules: QR Verification & Biometrics */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Face / Biometric Consistency Card */}
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div className="flex items-center gap-2">
