...
export const AnalysisResultPage: FC<{ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Side-By-Side Evidence Viewer with Dynamic Image URL */}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
          ...
          <div className="text-xs text-slate-400 space-y-1.5">
            ...
            {doc.tamperingDetected && (
              <p className="text-amber-400">• Boundary sharpness analysis suggests potential digital cut-and-paste onto background canvas.</p>
            )}
          </div>
        </div>
      </div>
